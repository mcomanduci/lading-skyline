    ...
    <div className="bg-cream overflow-hidden">
      <div className="max-w-7xl px-8 mx-auto flex flex-col lg:flex-row items-start">
        ...
        <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-3 mt-5 md:mt-0 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out">
              <button
                className="bg-white w-14 h-14 rounded-full flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-yellow focus:ring-offset-2"
                aria-label="Watch how Skilline works - play video demonstration"
        ...
        <div className="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
          <div className="w-10/12 mx-auto 2xl:-mb-20 relative">
            <Image
              data-aos="fade-up"
              data-aos-once="true"
              src="/girl.png"
          ...
          >
            <Image
              ...
              width={300}
              height={100}
              className="h-12 sm:h-16 w-auto rounded-xl bg-white/80"
            />
          </div>
          {/* <!-- red --> */}
          <div
          ...
          >
            <Image
              className="bg-white/80 rounded-lg h-20 sm:h-28 w-auto"
              src="/ux-class.svg"
              alt="User experience class"
              width={390}
              height={187}
            />
          </div>
          ...
          >
            <Image
              className="bg-white/80 rounded-lg h-12 sm:h-16 w-auto"
              src="/congrat.svg"
