...
export default function NavBar() {
  ...
  // Close mobile menu when screen size becomes mobile
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div className="w-full text-gray-700 bg-cream">
      <div className="flex flex-col max-w-7xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
        ...
        <nav
          id="mobile-menu"
          className={`flex flex-col grow md:items-center pb-4 md:pb-0 md:flex md:justify-end md:flex-row origin-top duration-300 ${
            open
              ? "h-full scale-y-100"
              : "h-0 scale-y-0 transform md:h-auto md:transform-none"
          }`}
          role="navigation"
